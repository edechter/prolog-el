...
;; see: http://emacs.stackexchange.com/questions/9925/persistent-shell-command-history
;; ----------------------------------------------------------------------
(defun turn-on-comint-history (filename)
...
(add-hook 'prolog-inferior-mode-hook
          (lambda ()
            (turn-on-comint-history "~/.inferior_prolog_history")))
...
;; NB: provide statement must be at end of filex
(provide 'prolog)
